...
void VERectangle::write(QJsonObject &json) const
{
...
void VERectangle::fromDrawing(Drawing &drawing)
{
...
Drawing VERectangle::toDrawing() const
{
    // TODO CHECK
    Drawing d;
...
int VERectangle::uniqueId() const
{
    return mUniqueId;
}

void VERectangle::setUniqueId(int uniqueId)
{
    mUniqueId = uniqueId;
}
